...
páginas web dinámicas [\cite{java_script}].
...
escritorio.
Entre las principales características que influyeron en que 
...
\begin{itemize}
    ...
    proyecto, con los paquetes y configuraciones para empezar a desarrollar una aplicación web.
