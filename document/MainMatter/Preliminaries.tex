...
\begin{table}[H]
    ...
    \begin{tabular}{ | c | c | c | c |}
      ...
      \hline
      Modelos de Optimización I   &  64   &  1/2 & \makecell{C: A. Marrero(16) \\ C: Pas. Fernando Rodríguez (16) \\ CP: Daniela González(32) \\ CP: Camila Pérez(32)}    \\ 
      \hline
...
puede cambiar de un año a otro. Por ejemplo, para la asignatura Modelos de Optimización I del
plan de estudio D para la carrera de Ciencia de la Computación, que 
...
secretario, presidente y oponente. Los profesores deben tener 
dominio acerca de los temas que se aborden en la investigación.

Decir algo acerca de que este año solo seran presidente y oponente en el 
tribunal.
