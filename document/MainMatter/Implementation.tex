...
en la figura tal se muestra la interfaz de usuario del sistema
que permite realizar esta tarea. \\

[VISTA DE LAS TESIS] \\

Con los botones tal y tal se hace esto y se pueden agregar tesis. Se sabe 
que se existe otra herramienta donde se guardan las tesis y se pudieran cargar a partir 
de ahi.


Cada vez que se agregue una tesis al sistema de gestión, se crea una  
instancia de tribunal de tesis con los campos de oponente y presidente sin asignar y  
una instancia de defensa de tesis con los campos fecha, hora y local sin asignar. 
En la figura tal y tal se muestra el resultado de agregar las tesis tales.\\

[IMG de los tribunales y defensas tras crear las tesis de la figura tal]\\

El próximo paso es asignar los profesores en los tribunales de tesis.
El encargado de realizar este proceso debe pulsar sobre el botón de editar 
de la fila correspondiente a al tribunal que desea definir. En la figura tal 
se muestra el resultado de pulsar sobre la fila tal para realizar la asignación. \\

[IMG DEL FORMULARIO PARA EDITAR TRIBUNAL DE TESIS]. \\

Cuando se hayan confeccionado los tribunales de tesis, el siguiente paso 
es realizar la planificación de las defensas, donde se debe definir la fecha, hora 
y local. En la figura tal se muestra la interfaz de usuario donde se debe realizar 
el proceso de planificación una vez se hayan confeccionado los tribunales.\\

[IMG de las defensas sin definir] \\
...
[IMG DEL FORMULARIO PARA EDITAR DEFENSA DE TESIS]. \\
